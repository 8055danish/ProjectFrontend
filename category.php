...
$query2 = "SELECT * from categories WHERE category_name='$category'";
      ...
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
          <div class="aa-product-catg-content">
              ...
              <ul class="aa-product-catg">
                ...
                <?php foreach($result1 as $key=>$value): ?>
                 <?php foreach ($result2 as $key1 => $value1): ?>
                  <?php if($value['product_id']==$value1['category_id']): ?>
                    <li>
                      <figure>
                        <a class="aa-product-img" href="product-detail.php?id=<?php echo $value['product_id']?>">
                          <img src="adminpanel\images\<?php echo $value['image']; ?>" alt="image missing..."></a>
                      ...
                      <div class="aa-product-hvr-content">
                        <a href="#" data-toggle2="tooltip" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal-<?php echo $value['product_id']?>"><span class="fa fa-search"></span></a>                            
                      </div>
                    </li>
                  <?php endif; ?>
                <?php endforeach; ?>
            ...
            <?php foreach ($result1 as $key => $value): ?>
              <!-- quick view modal -->                  
              <div class="modal fade" id="quick-view-modal-<?php echo $value['product_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="aa-product-view-content">
                          ...
                          <div class="aa-prod-view-bottom">
                            <a href="session.php?id=<?php echo $value['product_id']?>" class="aa-add-to-cart-btn"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <a href="product-detail.php?id=<?php echo $value['product_id'];?>" class="aa-add-to-cart-btn">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="aa-product-catg-pagination">
          <nav>
            <ul class="pagination">
              ...
              <?php for($a=1;$a<=5;$a++): ?>
                <li><a href="category_pagin.php?page=<?php echo $a; ?>"><?php echo $a?></a></li>
              <?php endfor;?>
              <li>
      ...
      <aside class="aa-sidebar">
        ...
        <div class="aa-sidebar-widget">
          ...
          <ul class="aa-catg-nav">
            ...
            <li><a href="category.php?category=Electornics">Electornics</a></li>
