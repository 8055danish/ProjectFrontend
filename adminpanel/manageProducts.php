	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-header">
			...
			<ul class="content-box-tabs">
				<li><a href="#tab1" class="default-tab">Manage Products</a></li> <!-- href must be unique and match the id of target div -->
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="#" title="title"><?php echo $value['name'];?></a></td>
