	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-header">
			...
			<ul class="content-box-tabs">
				<li><a href="#tab1" class="default-tab">Manage Order</a></li> <!-- href must be unique and match the id of target div -->
				...
				<tbody>
					<?php foreach($result1 as $key=>$value): ?>
						<tr>
							...
							<td><a href="#" title="title"><?php echo $value['product_name'];?></a></td>
